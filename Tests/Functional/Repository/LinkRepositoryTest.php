...
/**
 * Functional test for the \Mirko\Typo3Newsletter\Domain\Repository\LinkRepository
 */
class LinkRepositoryTest extends \Mirko\Typo3Newsletter\Tests\Functional\AbstractFunctionalTestCase
{
    /** @var LinkRepository */
