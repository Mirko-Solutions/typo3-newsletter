...
return [
    ...
    'columns' => [
        ...
        'type' => [
            ...
            'config' => [
                ...
                'renderType' => 'selectSingle',
                'items' => [
                    ['LLL:EXT:typo3_newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_be_users', \Mirko\Typo3Newsletter\Domain\Model\RecipientList\BeUsers::class],
                    ['LLL:EXT:typo3_newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_fe_groups', \Mirko\Typo3Newsletter\Domain\Model\RecipientList\FeGroups::class],
                    ['LLL:EXT:typo3_newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_fe_pages', \Mirko\Typo3Newsletter\Domain\Model\RecipientList\FePages::class],
                    ['LLL:EXT:typo3_newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_sql', \Mirko\Typo3Newsletter\Domain\Model\RecipientList\Sql::class],
                    ['LLL:EXT:typo3_newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_csv_file', \Mirko\Typo3Newsletter\Domain\Model\RecipientList\CsvFile::class],
                    ['LLL:EXT:typo3_newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_csv_list', \Mirko\Typo3Newsletter\Domain\Model\RecipientList\CsvList::class],
                    ['LLL:EXT:typo3_newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_csv_url', \Mirko\Typo3Newsletter\Domain\Model\RecipientList\CsvUrl::class],
                    ['LLL:EXT:typo3_newsletter/Resources/Private/Language/locallang_db.xlf:tx_newsletter_domain_model_recipientlist.type_html', \Mirko\Typo3Newsletter\Domain\Model\RecipientList\Html::class],
                ],
                'maxitems' => 1,
                'default' => \Mirko\Typo3Newsletter\Domain\Model\RecipientList\Sql::class,
            ],
        ],
        'html_url' => [
    ...
    'types' => [
        ...
        \Mirko\Typo3Newsletter\Domain\Model\RecipientList\BeUsers::class => ['showitem' => 'hidden;;1, title, plain_only, lang, type, be_users, recipients_preview'],
        \Mirko\Typo3Newsletter\Domain\Model\RecipientList\FeGroups::class => ['showitem' => 'hidden;;1, title, plain_only, lang, type, fe_groups, recipients_preview'],
        \Mirko\Typo3Newsletter\Domain\Model\RecipientList\FePages::class => ['showitem' => 'hidden;;1, title, plain_only, lang, type, fe_pages, recipients_preview'],
        \Mirko\Typo3Newsletter\Domain\Model\RecipientList\Sql::class => ['showitem' => 'hidden;;1, title, plain_only, type, sql_statement, sql_register_bounce, sql_register_open, sql_register_click, recipients_preview'],
        \Mirko\Typo3Newsletter\Domain\Model\RecipientList\CsvFile::class => ['showitem' => 'hidden;;1, title, plain_only, type, csv_separator, csv_fields, csv_filename, recipients_preview'],
        \Mirko\Typo3Newsletter\Domain\Model\RecipientList\CsvList::class => ['showitem' => 'hidden;;1, title, plain_only, type, csv_separator, csv_fields, csv_values, recipients_preview'],
        \Mirko\Typo3Newsletter\Domain\Model\RecipientList\CsvUrl::class => ['showitem' => 'hidden;;1, title, plain_only, type, csv_separator, csv_fields, csv_url, recipients_preview'],
        \Mirko\Typo3Newsletter\Domain\Model\RecipientList\Html::class => ['showitem' => 'hidden;;1, title, plain_only, lang, type, html_url, html_fetch_type, recipients_preview'],
    ],
    'palettes' => [
        '1' => ['showitem' => ''],
    ],
